...
def create_peft_model(num_labels, args):
    ...
    if args.model == 'roberta_large':
        model = RobertaForSequenceClassification.from_pretrained(
            '/home/xsj/fedex-lora-main/roberta_large', num_labels=num_labels
        )
        peft_config = LoraConfig(
            ...
            use_rslora=args.rslora,     ## Disable rank-sensitive LoRA for simpler tasks
